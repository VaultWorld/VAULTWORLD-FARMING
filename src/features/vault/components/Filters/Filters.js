...
const Filters = ({
  ...
  return (
    <Grid container spacing={2} className={classes.container} style={{ borderRadius: "10px", padding: "40px", background: "none" }}>
      ...
      <InputLabel style={{ fontSize: "20px" }} id="select-platform-label" className={classes.selectorLabel}>
            {t('Filters-Platform')}
          </InputLabel>
        <FormControl className={classes.selectorContainer}>
          <Select
            ...
            style={{ fontSize: "20px", border: "1px solid lightgrey", borderRadius: "10px", padding: "10px" }}
      ...
      <Grid item xs={6} md={3} xl={3}>
      <InputLabel style={{ fontSize: "20px" }} id="select-vault-type-label" className={classes.selectorLabel}>
        ...
        <FormControl className={classes.selectorContainer}>
          ...
          <Autocomplete
            ...
            renderInput={params => (
              <TextField
                {...params}
                style={{ fontSize: "20px", border: "1px solid lightgrey", borderRadius: "10px", padding: "13px" }}
                InputLabelProps={{
      ...
      <InputLabel style={{ fontSize: "20px" }} id="select-order-label" className={classes.selectorLabel}>
            {t('Filters-Sort')}
          </InputLabel>
        <FormControl className={classes.selectorContainer}>
          ...
          <Select
            ...
            style={{ fontSize: "20px", boxShadow:"0 0 2px #f7f7f7", border: "1px solid lightgrey", borderRadius: "10px", padding: "10px" }}
          >
