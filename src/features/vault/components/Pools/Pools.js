...
export default function Pools() {
  ...
  return (
    <Grid container className={classes.container}>
      <Grid item xs={12}>
        <h1 style={{color:"#da251e",textShadow:"0px 0px 8px #da251e"}} className={classes.title}>{t('Vault-Network')}</h1>
        {/* <NetworksToggle /> */}
      </Grid>
      <Grid item xs={12}>
        <div className={classes.tvl}>
          <span className={classes.title} style={{color:"#da251e", textShadow:"0px 0px 8px #da251e"}}>
            TVL{' '}
